...
* 2022년 01월 03일 : 18챕터: BERT 텍스트 분류, 개체명 인식, 질의 응답, NLI 실습 코드를 추가.  
* 2022년 01월 18일 : 22챕터: KoGPT-2를 이용한 파인 튜닝 코드를 추가. (텍스트 생성, 챗봇, 텍스트 분류)  
* 2022년 01월 20일 : 21챕터: BERT를 이용한 키워드 추출 알고리즘 키버트(KeyBERT) 실습 추가.
